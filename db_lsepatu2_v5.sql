...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2019 at 09:23 AM
...
INSERT INTO `tbl_paket` (`paket_id`, `paket_nama`, `paket_keterangan`, `paket_satuan`, `paket_harga`) VALUES
('PK01', 'deep clean', 'deep clean adalah metode pembesihan secara menyeluruh...', 'satu pasang', 20000),
('PK02', 'unyellowing', 'unyellowing adalah cara pembersihan dari warna sepatu yang sudah penguningan', 'satu pasang', 25000),
('PK03', 'recolour', 'recolour adalah pewarnaan ulang pada sepatu supaya sepatu terlihat seperti baru lagi', 'satu pasang', 80000);
