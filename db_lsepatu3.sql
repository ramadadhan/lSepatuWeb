...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2019 at 05:17 PM
...
INSERT INTO `tbl_admin` (`admin_id`, `admin_tanggal`, `admin_nama`, `admin_username`, `admin_password`, `admin_level`, `admin_status`) VALUES
...
(53, '2019-05-22 15:20:36', 'farhanrizal', '$2y$10$n840QD7edLRZnBg42J7oM.55yz.NDl.AwAeGMQlYg9Pqg1WRcFPmK', 'korewamovie01@gmail.com', '2', '1'),
...
--
-- AUTO_INCREMENT for table `tbl_menu_akses`
--
ALTER TABLE `tbl_menu_akses`
  MODIFY `akses_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_token`
  MODIFY `tk_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
