...
INSERT INTO `tbl_admin` VALUES (1,'2019-04-28 06:34:59','admin','admin','yadri.amz@gmail.com','1','1'),(2,'2019-04-28 06:34:59','pegawai','pegawai','','2','1'),(51,'2019-05-15 04:10:58','yadri','$2y$10$BkuERaA./Yek5fqIbRGXq.hZJLapq71lHMKgLgxZ8U7hbXRzguJT.','yadribl@gmail.com','1','1');
...
INSERT INTO `tbl_detail_transaksi_masuk` VALUES (1,'TM2804190001','PK01','deep clean','satu pasang',20000,2,40000),(2,'TM2804190001','PK02','unyellowing','satu pasang',25000,2,50000),(3,'TM2804190002','PK01','deep clean','satu pasang',20000,1,20000),(4,'TM2804190002','PK02','unyellowing','satu pasang',25000,2,50000),(5,'TM2804190003','PK02','unyellowing','satu pasang',25000,1,25000),(6,'TM2804190003','PK03','recolour','satu pasang',80000,1,80000),(7,'TM2904190001','PK01','deep clean','satu pasang',20000,1,20000),(8,'TM2904190001','PK02','unyellowing','satu pasang',25000,1,25000),(9,'TM2904190001','PK03','recolour','satu pasang',80000,1,80000),(10,'TM3004190001','PK01','deep clean','satu pasang',20000,3,60000),(11,'TM3004190001','PK02','unyellowing','satu pasang',25000,2,50000),(12,'TM3004190002','PK01','deep clean','satu pasang',20000,1,20000),(13,'TM0205190001','PK02','unyellowing','satu pasang',25000,2,50000),(14,'TM0205190001','PK03','recolour','satu pasang',80000,1,80000);
...
INSERT INTO `tbl_transaksi_keluar` VALUES ('TK2904190001','2019-04-29 13:49:27','TM2804190001',0,90000,100000,10000,1,NULL,'susilawati','madura','085447447445'),('TK2904190002','2019-04-29 14:16:17','TM2804190002',0,70000,70000,0,2,NULL,'Farhan','Jurangsapi','085221445669');
...
CREATE TABLE `tbl_transaksi_masuk` (
  ...
  CONSTRAINT `tbl_transaksi_masuk_ibfk_1` FOREIGN KEY (`tm_admin_id`) REFERENCES `tbl_users` (`users_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_transaksi_masuk` VALUES ('TM0205190001','2019-05-02 06:39:21',3,130000,2,'ahew',0,'dadhan','perum puri','085221244122','belum','belum'),('TM2804190001','2019-04-28 14:57:46',4,90000,2,'TIDAK ADA',0,'susilawati','madura','085447447445','belum','belum'),('TM2804190002','2019-04-28 14:58:38',3,70000,2,'gk tau dah',0,'Farhan','Jurangsapi','085221445669','belum','belum'),('TM2804190003','2019-04-28 15:00:01',2,105000,2,'isi sembarang',0,'yadri','kaliurang','085441225447','belum','belum'),('TM2904190001','2019-04-29 15:17:51',3,125000,2,'fa',0,'fa','fa','02','belum','belum'),('TM3004190001','2019-04-30 02:42:34',5,110000,2,'hggug',0,'yadreh','c32','085221225224','belum','belum'),('TM3004190002','2019-04-30 08:33:17',1,20000,2,'tidak ada',0,'ada','ada','ada','belum','belum');
...
-- Dump completed on 2019-05-23 21:45:34
